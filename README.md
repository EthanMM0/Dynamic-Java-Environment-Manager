...
Auto-detects JDKs from common install locations and custom paths

One-click switch between Java versions

User-level environment updates (safe, no admin rights needed)

Pastel “sketchboard” UI with animated buttons and shadows
